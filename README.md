...
- **ChatGPT (versão gratuita):**  
  ...
  - Permite carregar **mais de uma planilha ao mesmo tempo** (foi possível anexar as 3 planilhas com dados brutos [Planilhas](https://github.com/LidianeSouza/analise-vendas-gamesshop-ia/tree/main/data-planilhas)). ![Captura de tela dados no ChatGPT](https://github.com/LidianeSouza/analise-vendas-gamesshop-ia/raw/main/images/chatgpt_prompt.png) 
...
- **Microsoft Copilot:**  
  ...
  - Permite carregar **apenas uma planilha por vez** (usei a planilha com os dados já processados [Planilhas](https://github.com/LidianeSouza/analise-vendas-gamesshop-ia/tree/main/data-planilhas)). ![Captura de tela dados no Copilot](https://github.com/LidianeSouza/analise-vendas-gamesshop-ia/raw/main/images/chatgpt_prompt.png)
